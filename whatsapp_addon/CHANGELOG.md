...
- Added a log line after each connection with how many offline messages
  WhatsApp announced and sent, and a warning if WhatsApp does not finish within
  a minute. Counts only, no identifiers.
